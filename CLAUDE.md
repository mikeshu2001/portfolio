...
Одностраничный сайт-визитка. Пользователь — **Михаил Шумовский**, главный
редактор «Нейромедиа» (проект Unisender) и AI-native product builder с
редакторским и маркетинговым бэкграундом. Не приписывать ему классическую
frontend/backend-роль или неподтверждённый стаж. Работает с прикладными
нейросетями, цифровым маркетингом и агентными продуктами.

Стек: чистый HTML/CSS/JS без сборки и зависимостей. Не предлагать React, Next, Tailwind, TypeScript и т. п. без явной просьбы.

## Подробности

- [docs/structure.md](docs/structure.md) — раскладка файлов: `index.html`, `css/`, `js/`
- [docs/sections.md](docs/sections.md) — 8 секций сайта и якоря
